...
import 'package:rentreerapide/custom_background.dart';
import 'package:rentreerapide/screens/auth/welcome_back_page.dart';
import 'package:rentreerapide/screens/settings/change_country.dart';
import 'package:rentreerapide/screens/settings/change_password_page.dart';
import 'package:rentreerapide/screens/settings/legal_about_page.dart';
import 'package:rentreerapide/screens/settings/notifications_settings_page.dart';
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  ListTile(
                    ...
                    onTap: ()async{
                      await HTTP.post(get_api_url('auth/logout') , body: {
                        'token':appDataBox.get('token')
                      });
                      appDataBox.delete('token');
