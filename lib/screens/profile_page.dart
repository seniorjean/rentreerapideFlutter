...
import 'package:rentreerapide/screens/faq_page.dart';
import 'package:rentreerapide/screens/payment/payment_page.dart';
import 'package:rentreerapide/screens/settings/settings_page.dart';
import 'package:rentreerapide/screens/tracking_page.dart';
import 'package:rentreerapide/screens/wallet/wallet_page.dart';
          ...
          child: Padding(
            ...
            child: Column(
              children: <Widget>[
                ...
                Padding(
                  padding: const EdgeInsets.fromLTRB(2.1 , 9.0, 2.1 , 2.1),
                  child: Row(
                    ...
                    children: [
                      ...
                      SizedBox(width:6.3),
                      Text(
                        '${appDataBox.get('first_name')} ${appDataBox.get('last_name')}',
